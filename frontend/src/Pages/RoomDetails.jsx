        ...
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col lg:flex-row my-6 gap-6'>
                <div className='lg:w-1/2 w-full'>
                    <img src={mainImage} alt="Room Image" className='w-full
            ...
            justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx:auto mt-16 max-w-6xl'>
                ...
                active:scale-95 trsansition-all text-white rounded-md max-md:w-full
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1 ml-2 mt-1">
                            ...
                            {[...Array(5)].map((_, i) => (
                                ...
                                >
                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.286 3.974a1 1 0 00.95.69h4.185c.969 0 1.371 1.24.588 1.81l-3.39 2.46a1 1 0 00-.364 1.118l1.286 3.974c.3.921-.755 1.688-1.54 1.118l-3.39-2.46a1 1 0 00-1.176 0l-3.39 2.46c-.784.57-1.838-.197-1.539-1.118l1.285-3.974a1 1 0 00-.364-1.118L2.32 9.401c-.783-.57-.38-1.81.588-1.81h4.185a1 1 0 00.95-.69l1.286-3.974z" />
                                </svg>
                            ))}
