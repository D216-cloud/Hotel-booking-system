...
const MyBooking = () => {
    ...
    return (
        <div className='py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24'>
            <Title title='My Bookings' subTitle='Easily manage your past, current, and upcoming hotel bookings in one place.
Plan your trips smoothly with just a few clicks.' align='left' />
            ...
            <div className='max-w-6xl mt-8 w-full text-gray-800'>
                ...
                {bookings.map((booking) => (
                    <div key={booking._id} className='grid grid-cols-1 md:grid-cols-[3fr_3fr_1fr] w-full border-border-gray-300 py-6 first:border-t'>
                        {/* --------Hotel Details----- */}
                        ...
                        <div className='flex flex-col items-start justify-center pt-3'>
                            ...
                            {!booking.isPaid && (
                                <button
                                    className='px-4 py-1.5 mt-4 text-xs text-white bg-gradient-to-r from-amber-500 to-orange-500 rounded-full hover:from-amber-600 hover:to-orange-600 shadow-md transition-all cursor-pointer'
                                >
                                    Pay Now
                                </button>
